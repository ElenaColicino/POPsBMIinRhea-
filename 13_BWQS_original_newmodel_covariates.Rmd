...
Outcomes:BMI was repeated over time (see "age of the child")

+ **Body Mass Index** (*bmi*): continuous outcome, regression analysis

We used eight POP chemicals. All POP concentrations were log10 trasformed:
...
We used the **age of the child** (*age*) to identify outcome trajectories
